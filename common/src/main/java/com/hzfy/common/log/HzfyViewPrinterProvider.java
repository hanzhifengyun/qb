...
import com.hzfy.library.util.DisplayUtil;

import androidx.recyclerview.widget.RecyclerView;


public class HzfyViewPrinterProvider {
    ...
    public HzfyViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showLogView() {
        ...
        FrameLayout.LayoutParams params =
            new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DisplayUtil.dp2px(180, rootView.getResources()));
